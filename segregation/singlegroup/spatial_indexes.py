...
from segregation.aspatial.multigroup_aspatial_indexes import (
...
def _spatial_prox_profile(data, group_pop_var, total_pop_var, m=1000):
    ...
    data = data.rename(
        columns={group_pop_var: "group_pop_var", total_pop_var: "total_pop_var"}
    )
...
class PerimeterAreaRatioSpatialDissim:
    ...
    def __init__(self, data, group_pop_var, total_pop_var, standardize=True):
        ...
        aux = _perimeter_area_ratio_spatial_dissim(
            data, group_pop_var, total_pop_var, standardize
        )
...
class DistanceDecayIsolation:
    ...
    def __init__(
        ...
        aux = _distance_decay_isolation(
            data, group_pop_var, total_pop_var, alpha, beta, metric
        )
...
class AbsoluteCentralization:
    ...
    def __init__(
        self, data, group_pop_var, total_pop_var, center="mean", metric="euclidean"
    ):
        ...
        aux = _absolute_centralization(
            data, group_pop_var, total_pop_var, center, metric
        )
